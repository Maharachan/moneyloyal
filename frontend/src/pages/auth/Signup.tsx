...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center font-[sans-serif] bg-white">
      <div className="max-w-4xl mx-auto py-8 p-4 w-full">
        <ToastContainer />
        <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
          ...
          <form onSubmit={handleSignup} className="md:col-span-2 w-full py-6 px-6 sm:px-12">
            <div className="mb-4">
